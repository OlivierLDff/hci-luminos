...
#oliv: fix compilation, may be required for android extra lib ??
...
#     INSTALL
#)
# oliv : DEPENDS isn't supported anymore in order to remove the OLD warning
# 
macro(add_qt_android_apk TARGET SOURCE_TARGET)
	...
	#oliv : don't know what this is for? maybe will need it for thing as vibrator lib, wifi, etc...?
	if(ARG_DEPENDS)
	...
	set(QT_ANDROID_APP_PATH @QT_ANDROID_APP_PATH@) # reconfigure file
	set(QT_ANDROID_APP_EXTRA_LIBS @QT_ANDROID_APP_EXTRA_LIBS@) # reconfigure file
